...
public class MainRelationBinaire {
    ...
    public static void main(String[] args) {
        ...
        RelationBinaire relationTest2 = new RelationBinaire(tabBoolTest2);
        relationTest2.toString();

        System.out.println("RELATION TEST 3");
        RelationBinaire relationTest3 = new RelationBinaire(tabBoolTest3);
        ...
        */
        ...
        System.out.println(relationTest1.estAntisymetrique());

        new RelationBinaire(new boolean[][]{
